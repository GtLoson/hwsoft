...
public class WithdrawalOrder {
	...
	@Column(name = "withdrawal_recode_id",nullable=false)
	private int withdrawalRecordId;
	...
	public int getWithdrawalRecordId() {
		return withdrawalRecordId;
	}

	public void setWithdrawalRecordId(int withdrawalRecordId) {
