...
public class MoneyConvert   {  
	  ...
	  public MoneyConvert(double amount) {
	    this.amount = amount;
	  }
	...
	*/
	  ...
	  public static void main(String[] args) {
	    System.out.println(toBigAmt(5000D));
	    System.out.println(toBigAmt(500000.00D));
	    System.out.println(toBigAmt(0.60D));
	    System.out.println(toBigAmt(00.60D));
	    System.out.println(toBigAmt(150.2101D));
	    System.out.println(toBigAmt(15400089666.234D));
	    System.out.println(toBigAmt(22200004444.2347D));
	  }
}  