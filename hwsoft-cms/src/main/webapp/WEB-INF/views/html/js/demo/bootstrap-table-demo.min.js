...
!function(e,t,o){
    ...
    !function(){
        ...
        function(){
            o("#exampleTableColumns").bootstrapTable({url:"js/demo/bootstrap_table_test.json",
                height:"400",
                iconSize:"outline",
                showColumns:!0,
                icons:{
        ...
        function(){
            o("#exampleTableToolbar").bootstrapTable({url:"js/demo/bootstrap_table_test2.json",
                search:!0,showRefresh:!0,showToggle:!0,showColumns:!0,
        ...
        function(){
            o("#exampleTableEvents").bootstrapTable({url:"js/demo/bootstrap_table_test.json",
